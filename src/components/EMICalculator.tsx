...
export function EMICalculator({
  ...
  return (
    <div className="portal-section p-5 sm:p-6 animate-slide-up">
      ...
      <div className="flex items-start gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1 leading-relaxed">
            Adjust the values to estimate your monthly EMI and total
            repayment.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              Move the slider to see how your EMI changes ·{' '}
              {rateMin}% – {rateMax}% {tr('perAnnum')}
            </p>

            <p className="text-xs text-slate-500 mt-2">
              Your actual interest rate will be decided by the
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                onChange={(e) =>
                  setMoratoriumMonths(e.target.value)
                }
                className="flex-1 accent-primary-600"
              />
        ...
        <div className="space-y-4">
          ...
          {result ? (
            <>
              {/* Monthly EMI */}
              <div className="border border-primary-200 bg-primary-50 rounded-md p-5 animate-scale-in">
              ...
              <div className="border border-slate-200 rounded-md divide-y divide-slate-200">
                ...
                <div className="flex items-center gap-3 p-4">
                  <div className="flex items-center justify-center w-9 h-9 rounded-md bg-warning-100 flex-shrink-0">
                    <CalendarClock className="w-5 h-5 text-warning-700" />
                  </div>

                  <div className="flex-1">
                    <p className="text-xs text-slate-500">
                      {tr('principal')} ({tr('afterMoratorium')})
                    </p>

                    <p className="text-base font-semibold text-slate-900">
                      ₹
                      {result.principal_after_moratorium.toLocaleString(
                        'en-IN'
                      )}
                    </p>
                  </div>
                ...
                {/* Interest */}
                <div className="flex items-center gap-3 p-4">
                  <div className="flex items-center justify-center w-9 h-9 rounded-md bg-slate-100 flex-shrink-0">
                ...
                {/* Total repayment */}
                <div className="flex items-center gap-3 p-4">
                  <div className="flex items-center justify-center w-9 h-9 rounded-md bg-success-100 flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base font-semibold text-slate-900">
                      ₹
                      {result.total_repayment.toLocaleString(
                        'en-IN'
                      )}
                    </p>
                  </div>
            ...
            <div className="flex items-center justify-center min-h-[220px] border border-slate-200 rounded-md bg-slate-50 text-sm text-slate-500 p-8 text-center">
      ...
      {/* Moratorium note */}
      <div className="portal-notice mt-5 border-warning-200 bg-warning-50">
      ...
      {result && showSchedule && (
        <div className="mt-6 animate-fade-in">
          ...
          <h3 className="portal-section-title mb-3">
            {tr('repaymentSchedule')}
          </h3>

          <div className="overflow-x-auto rounded-md border border-slate-200 max-h-64">
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-right text-slate-600 text-xs">
                      {row.principal_component
                        ? `₹${row.principal_component.toLocaleString(
                            'en-IN'
                          )}`
                        : '—'}
                    </td>
