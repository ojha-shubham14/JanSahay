  ...
  if (showLanguageModal) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-[2px] px-4 animate-fade-in">
        <div className="w-full max-w-lg rounded-xl bg-white p-6 sm:p-8 shadow-2xl dark:bg-slate-900 animate-popup-attention">
            ...
            {languages.map((language) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-lg border-2 px-3 py-3 transition-colors duration-150 ${
                    selected
          ...
          <button
            ...
            className="w-full mt-6 inline-flex items-center justify-center gap-2 rounded-md bg-primary-600 px-5 py-3.5 text-white font-semibold hover:bg-primary-700 transition-colors duration-150 shadow-sm"
          >
            {tr('continueLanguage')}
        ...
        <div className="portal-notice">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 mt-1 leading-relaxed dark:text-slate-400">
